...
function api(app){
    ...
    app.get('/api/groups', middlewareController.checkAuth, apiController.groupChatList)
    app.get('/api/group-chat-list', middlewareController.checkAuth, apiController.groups)
